...
export class AddEntities1766657650243 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."service_sections_service_section_name_enum" AS ENUM('LAP_FOE', 'LAP_CARE', 'CHIP_LEVEL', 'DESKTOP_CARE', 'IPG', 'VENDOR_ASP', 'OUTSOURCE', 'OUTDOOR')`);
